...
interface FormData {
    ...
    project_workweek_start: string;
    project_workweek_finish: string;
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value: string) => handleSelectChange('project_workweek_start', value)}
                                    >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value: string) => handleSelectChange('project_workweek_finish', value)}
                                    >
