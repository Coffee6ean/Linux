...
class PdfTextProcessing():
    ...
    @staticmethod
    def main():
        project = PdfTextProcessing.generate_ins()
    ...
    def generate_ins():
        ...
        return PdfTextProcessing(input_files_path, output_files_path)
    ...
    def interpret_text(self, input_dir, output_path, output_basename):
        ...
        file_dir = [file for file in PdfTextProcessing.get_type_files(input_dir, "txt") if "clean" in file][0]
...
if __name__ == "__main__":
    PdfTextProcessing.main()
    #print(PdfTextProcessing.get_type_files("/home/coffee_6ean/Linux/CriticalFlowPath/src/local_results/output_images", "txt"))
    #print(test())
