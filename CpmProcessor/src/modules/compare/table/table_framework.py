...
class TableFramework:
    ...
    def main(auto=True, input_file_path=None, input_file_basename=None, input_file_extension=None, 
        ...
        if auto:
            project = TableFramework.auto_generate_ins(
                input_file_path, 
                input_file_basename, 
            ...
            project = TableFramework.generate_ins()

        if project:
            table, color_list = project.design_json_table(project.ordered_dict)
            project.create_wbs_table(table)
    ...
    @staticmethod
    def generate_ins():
        TableFramework.ynq_user_interaction(
    ...
    def design_json_table(self, json_dict:dict):
        ...
        color_list = proc_table.index.get_level_values("color").to_list()
        ...
        proc_table = proc_table[temp_list_2]
